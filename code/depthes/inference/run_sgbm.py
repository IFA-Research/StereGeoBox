...
for left_name in tqdm(left_images, desc="SGBM"):
...
if all_results:
    pd.DataFrame(all_results).to_excel(os.path.join(args.output_dir, "results_SGBM.xlsx"), index=False)
