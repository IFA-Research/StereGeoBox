...
for left_name in tqdm(left_images, desc="AANet"):
    ...
    npz_path = os.path.join(args.depth_dir, f"{base}_disp.npz")
...
if all_results:
    pd.DataFrame(all_results).to_excel(os.path.join(args.output_dir, "results_AANet.xlsx"), index=False)
